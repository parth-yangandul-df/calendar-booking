...
export function MyBookingsTab({ bookings }: MyBookingsTabProps) {
  ...
  if (bookings.length === 0) {
    return (
      <div className="text-center py-12">
        <h3 className="text-base font-medium text-foreground mb-1">No bookings yet</h3>
        <p className="text-sm text-muted-foreground mb-3">
          Browse people's calendars to request a booking.
        </p>
        ...
        <div key={booking.id} className="flex items-center justify-between p-3 border rounded-lg">
          <div className="flex items-center gap-3">
            ...
            <div className="text-sm">
              <div className="font-medium">{booking.ownerEmail}</div>
